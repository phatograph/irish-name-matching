...
\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {1}Levenshtein distance implementation.}{11}{lstlisting.1}
\contentsline {lstlisting}{\numberline {2}Soundex implementation.}{12}{lstlisting.2}
\contentsline {lstlisting}{\numberline {3}Soundex grouping table implementation.}{13}{lstlisting.3}
\contentsline {lstlisting}{\numberline {4}Soundex similarity score implementation.}{14}{lstlisting.4}
\contentsline {lstlisting}{\numberline {5}Irish soundex implementation.}{15}{lstlisting.5}
\contentsline {lstlisting}{\numberline {6}Lookup table implementation.}{17}{lstlisting.6}
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {7}\texttt {sample.json}.}{24}{lstlisting.7}
\contentsline {lstlisting}{\numberline {8}Result from \texttt {sample.json}.}{25}{lstlisting.8}
\contentsline {lstlisting}{\numberline {9}Jbuilder template for generating \texttt {JSON} results.}{26}{lstlisting.9}
\addvspace {10\p@ }
...
\contentsline {lstlisting}{\numberline {17}\texttt {matching\_algorithm.rb}.}{34}{lstlisting.17}
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {18}Sample \texttt {JSON} with a standard name list option.}{37}{lstlisting.18}
